 ...
 */
public class SubSceneXLabel extends XBaseScene {
...
//        loadFont("/system/font/Roboto-Regular.ttf", XUI.Location.SDCARD);
        ...
        xLabelLeft.setCenterPosition(0, 0.3f, CENTER_Z);
        xLabelLeft.setSize(2.0f, 0.3f);
        ...
        xLabel.setCenterPosition(0, -0.2f, CENTER_Z);
        //通过Color设置文本颜色
        //Set text color through Color
        xLabel.setTextColor(Color.BLUE);
        xLabel.setSize(3.0f, 0.3f);
        addActor(xLabel);
        ...
        xLabelStyle.setCenterPosition(0, -0.7f, CENTER_Z);
        xLabelStyle.setSize(3.0f, 0.3f);
        ...
        xLabelRight.setCenterPosition(0, -1.2f, CENTER_Z);
        //通过ARGB设置文本颜色
        //Set text color through ARGB
        xLabelRight.setTextColor(Color.argb(255, 0, 255, 0));
        xLabelRight.setSize(2.4f, 0.3f);
        ...
        xLabelUpdate.setCenterPosition(0, -1.7f, CENTER_Z);
        xLabelUpdate.setTextColor(Color.WHITE);
        xLabelUpdate.setSize(2.4f, 0.3f);
        ...
        OneTime.setCenterPosition(0, -2.2f, CENTER_Z);
        OneTime.setSize(2.4f, 0.3f);
        addActor(OneTime);
        ...
        xLabelMultiLines.setCenterPosition(0, -2.7f, CENTER_Z);
        xLabelMultiLines.setSize(3.0f, 0.3f);
