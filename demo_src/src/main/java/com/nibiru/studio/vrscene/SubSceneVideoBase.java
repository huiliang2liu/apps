...
public class SubSceneVideoBase extends XBaseScene  {
    ...
    public static final int MODEL_EAC = 4;


    protected MediaPlayer mediaPlayer;
    public XSurfaceArea xSurfaceArea;
    ...
    private void initPlayer() {
        ...
        if (xSurfaceArea != null && videoPath != null) {
            ...
            if (!new File(videoPath).exists()) {
                XToast toast = XToast.makeToast(this, "Cannot found video file: " + videoPath, 5000);
    ...
    private XSurfaceArea.Parameters getVideoParameters(int type, int model) {
        ...
        XVec3 center = new XVec3(0f, 0f, -DISTANCE - 1f);
...
//                    xSurfaceArea.rotateBy(-90f, 0, 0);
            } else if(model == MODEL_EAC) {
                return new XSurfaceArea.Builder(this, XSurfaceConfig.Mode.MODE_2D, XSurfaceConfig.Format.TYPE_CUBEMAP_EAC)
                        .setCenter(center1)
                        .setRadius(10)
                        .buildParameters();
            }
            ...
            if (model == MODEL_PLANE) {
                ...
                return new XSurfaceArea.Builder(this, XSurfaceConfig.Mode.MODE_3D, XSurfaceConfig.Format.TYPE_CUBEMAP_EAC)
                        .setCenter(center1)
                        .setRadius(10)
                        .setVideoLayout(type == TYPE_3D_LEFTRIGHT ? XSurfaceConfig.Layout.LAYOUT_HORIZONTAL : XSurfaceConfig.Layout.LAYOUT_VERTICAL)
                        .buildParameters();
