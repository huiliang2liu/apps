 ...
 */
public class SubSceneXImage extends XBaseScene {
    ...
    public void init() {
        ...
        XLabel mTip = new XLabel("Images from Assets, SDCard, Resource, Network");
        mTip.setAlignment(XAlign.Center);
        mTip.setArrangementMode(XArrangementMode.SingleRowNotMove);
        mTip.setCenterPosition(0, 1.5f, -4f);
        mTip.setSize(3.8f, 0.2f);
        addActor(mTip);
...
//        xImage1 = new XImage("ic_image_focused.png");
        ...
        xImage1.setCenterPosition(-3f, 0.8f, -4f);
        xImage1.setSize(1f, 1f);
...
//        xImage1.setRotation(0, 0, -90);
        ...
        xImage2.setCenterPosition(-1.5f, 0.8f, -4);
        xImage2.setSize(1f, 1f);
        ...
        xImage3.setCenterPosition(0f, 0.8f, -4);
        xImage3.setSize(1f, 1f);
        ...
        xImage4.setCenterPosition(1.5f, 0.8f, -4);
        xImage4.setSize(1f, 1f);
        ...
        xImage6.setCenterPosition(3f, 0.8f, -4f);
        xImage6.setSize(1f, 1f);
        ...
        mClipTip.setCenterPosition(0, -0.4f, -4f);
        mClipTip.setSize(3.8f, 0.2f);
        addActor(mClipTip);

        xImage5 = new XImage("yejingtu.png");
        xImage5.setName("Image_Clip");
        xImage5.setCenterPosition(0f, -1.2f, -4f);
        xImage5.setSize(1f, 1f);
