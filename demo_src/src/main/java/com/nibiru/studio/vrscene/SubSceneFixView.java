 ...
 */
public class SubSceneFixView extends XBaseScene {
    ...
    public void init() {
        ...
        followGazeTip.setCenterPosition(0f, 0.6f, -4f);
        followGazeTip.setSize(4.6f, 0.2f);
        addActor(followGazeTip);


        xImage = new XImage("ic_image_focused.png");
        xImage.setSize(0.6f, 0.6f);
        xImage.setCenterPosition(0, 0.0f, -4f);
        ...
        fixviewTip.setCenterPosition(0, -1.0f, -4f);
        fixviewTip.setTextColor(Color.WHITE);
        fixviewTip.setSize(2.6f, 0.2f);
        addActor(fixviewTip);


        XLabel fixviewCancelTip = new XLabel("Click to Cancel Re-locate");
        fixviewCancelTip.setAlignment(XLabel.XAlign.Center);
        fixviewCancelTip.setCenterPosition(0f, -1.4f, -4f);
        fixviewCancelTip.setSize(3.6f, 0.2f);
