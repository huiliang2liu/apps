...
public class SubSceneOSAPI extends BaseScene implements IXActorEventListener {
    ...
    public boolean onGazeTrigger(XActor actor) {
        ...
        //Play video file
            ...
            if( selectedVideoPath == null || !new File(selectedVideoPath).exists() || !isVideo(selectedVideoPath.toLowerCase())){
                ...
                toast.setGravity(0.0f, 0f, CalculateUtils.CENTER_Z + 0.05f);
                toast.setSize(0.4f, 0.03f);
                toast.setRenderOrder(100);
                toast.show(true);
                return true;
            }else{
        ...
        //Browse selected image files
            ...
            if( selectedImagePath == null || !new File(selectedImagePath).exists() || !isImage(selectedImagePath.toLowerCase())){
                ...
                toast.setGravity(0.0f, 0f, CalculateUtils.CENTER_Z + 0.01f);
                toast.setSize(0.4f, 0.03f);
                toast.setRenderOrder(100);
                toast.show(true);
                return true;
