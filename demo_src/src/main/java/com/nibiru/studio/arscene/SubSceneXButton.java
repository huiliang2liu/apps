 ...
 * Show XButton
 */
public class SubSceneXButton extends BaseScene implements XButton.IXOnClickListener {
...
//        xButton.setText("Button Selected", "Button");
        ...
        xButton1.setCenterPosition(-0.09f, 0.08f, CalculateUtils.CENTER_Z);
        //设置整个按钮的大小
        //Set button size
        xButton1.setSize(0.15F, 0.05F);
        //设置字体大小
        //Set text size
        ...
        xButton2.setCenterPosition(0.09f, 0.08f, CalculateUtils.CENTER_Z);
        //设置整个按钮的大小
        //Set button size
        xButton2.setSize(0.15F, 0.05F);
        //设置字体大小
        //Set text size
        ...
        xButton3.setCenterPosition(-0.09f, 0f, CalculateUtils.CENTER_Z);
        //设置整个按钮的大小
        //Set the button size
        xButton3.setSize(0.15F, 0.05F);
        //设置字体大小
        //Set text size
        xButton3.setTextSize(0.025f);
        ...
        xButton4.setCenterPosition(0.09f, 0f, CalculateUtils.CENTER_Z);
        //设置整个按钮的大小
        //Set the button size
        xButton4.setSize(0.15F, 0.05F);
        //设置字体大小
        //Set text size
        xButton4.setTextSize(0.025f);
        ...
        xButton5.setCenterPosition(-0.09f, -0.08f, CalculateUtils.CENTER_Z);
        //设置整个按钮的大小
        //Set button size
        xButton5.setSize(0.15F, 0.05F);
        //设置字体大小
        //Set text size
        xButton5.setTextSize(0.025f);
    ...
    public boolean onClick(XActor actor) {
        ...
        toast.setGravity(0.0f, -0.06f, CalculateUtils.CENTER_Z + 0.1f);
