 ...
 */
public class SubSceneXEditText extends BaseScene {
    ...
    public void init() {
        ...
        //设置输入文本的布局，默认显示超出最大显示长度时显示最右侧文字
        //Set the layout of input text, display text on the right side when it's overlength
//        editStyle.xArrangementMode = XArrangementMode.SingleRowClipRight;
        ...
        mEditText.setCenterPosition(0, 0f, CalculateUtils.CENTER_Z);
        mEditText.setSize(0.2f, 0.03f);
...
//                    editText.setTextContent("");
        ...
        mEditPwd.setCenterPosition(0, -0.05f, CalculateUtils.CENTER_Z);
        mEditPwd.setSize(0.2f, 0.03f);
        ...
        final XEditText edit = new XEditText("Input Test1", editStyle);
        ...
        edit.setName("XEdit1");
        edit.setCenterPosition(0, -0.1f, CalculateUtils.CENTER_Z);
        edit.setSize(0.2f, 0.03f);
...
//        editStyle2.cursorColor = Color.GREEN;
        ...
        mEditTextTest2.setCenterPosition(0, -0.15f, CalculateUtils.CENTER_Z);
        mEditTextTest2.setSize(0.2f, 0.03f);
...
//                    editText.setTextContent("");
        ...
        mEditTextTest2.setIMEOffset(0, 0.02f, 0);
        ...
        inputResult.setCenterPosition(0, -0.2f, CalculateUtils.CENTER_Z);
        inputResult.setTextColor(Color.WHITE);
        inputResult.setSize(0.08f, 0.03f);
