 ...
 */
public class SubSceneActor extends BaseScene implements IXActorEventListener {
    ...
    public void onCreate() {
        ...
        if( intent != null ){
            ...
            if( param != null ){
                ...
                //If the parameter is not null, printit in Logcat
    ...
    XLabel addLabel(String labelText, int index){
        ...
        if(labelText.equals("Follow")) {
            ...
            xLabel.setCenterPosition(0, mStartY+mIntervalY*index, CalculateUtils.CENTER_Z + 0.05f);
            xLabel.setRenderOrder(50);
//            xLabel.setFollowAdaptPos(0, 0,  CalculateUtils.CENTER_Z + 0.05f);
            ...
            xLabel.setCenterPosition(0, mStartY+mIntervalY*index, CalculateUtils.CENTER_Z + 0.06f);
            dragLabel = xLabel;
            ...
            dragLabel.setDragDistanceRange(0.6f, 0.7f);
            ...
            xLabel.setCenterPosition(0, mStartY+mIntervalY*index, CalculateUtils.CENTER_Z);
        }
        addActor(xLabel);
    ...
    public boolean onKeyDown(int keyCode) {
        if(dragLabel.isDraggingActor()) {
            ...
            if(keyCode == KeyEvent.KEYCODE_DPAD_UP) {
                dragLabel.setDragDistanceOffset(-0.1f);
