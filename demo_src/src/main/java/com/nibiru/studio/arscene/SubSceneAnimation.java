...
public class SubSceneAnimation extends XBaseScene implements IXActorEventListener {
    ...
    void initAnimation(){
        ...
        animationLabel.setCenterPosition(0, 0.06f, CalculateUtils.CENTER_Z);
        animationLabel.setTextColor(Color.WHITE);
        animationLabel.setSize(0.38f, 0.02f);
        addActor(animationLabel);

        mRotActor = new XImage("ic_image_focused.png");
        mRotActor.setCenterPosition(-0.2f, 0.0f, CalculateUtils.CENTER_Z);
        mRotActor.setSize(0.05f, 0.05f);
        ...
        mScaleActor.setCenterPosition(-0.1f, 0.0f, CalculateUtils.CENTER_Z);
        mScaleActor.setSize(0.05f, 0.05f);
        ...
        mTransActor.setCenterPosition(0f, 0.0f, CalculateUtils.CENTER_Z);
        mTransActor.setSize(0.05f, 0.05f);
        ...
        mAlphaActor.setCenterPosition(0.1f, 0.0f, CalculateUtils.CENTER_Z);
        mAlphaActor.setSize(0.05f, 0.05f);
        ...
        mFrameActor.setCenterPosition(0.2f, 0.0f, CalculateUtils.CENTER_Z);
        mFrameActor.setSize(0.05f, 0.05f);
    ...
    void trans(XActor xImage) {
        ...
        if (mTranslateAnimation == null) {
            ...
            mTranslateAnimation = new XTranslateAnimation(0.03f, 500, XAnimation.REPEAT_LOOP);
    ...
    void initGazeAnimation(){
        ...
        animationLabel.setAlignment(XLabel.XAlign.Center);
        animationLabel.setArrangementMode(XLabel.XArrangementMode.SingleRowNotMove);
        animationLabel.setCenterPosition(0, -0.05f, CalculateUtils.CENTER_Z);
        animationLabel.setTextColor(Color.WHITE);
        animationLabel.setSize(0.38f, 0.02f);
        addActor(animationLabel);
        ...
        mImage1.setCenterPosition(-0.2f, -0.1f, CalculateUtils.CENTER_Z);
        mImage1.setSize(0.05f, 0.05f);
        //开启默认选中动画，默认为平移动画
        ...
        mImage2.setCenterPosition(-0.1f, -0.1f, CalculateUtils.CENTER_Z);
        mImage2.setSize(0.05f, 0.05f);
        ...
        mImage2.setGazeAnimation(XAnimation.AnimationType.TRANSLATE, 0.1f, 200);
        addActor(mImage2);

        XImage mImage3 = new XImage("photo1.png");
        mImage3.setCenterPosition(0f, -0.1f, CalculateUtils.CENTER_Z);
        mImage3.setSize(0.05f, 0.05f);
        ...
        mImage4.setCenterPosition(0.1f, -0.1f, CalculateUtils.CENTER_Z);
        mImage4.setSize(0.05f, 0.05f);
        ...
        mImage5.setCenterPosition(0.2f, -0.1f, CalculateUtils.CENTER_Z);
        mImage5.setSize(0.05f, 0.05f);
    ...
    public void initImageAnimation(){
        ...
        animationLabel.setAlignment(XLabel.XAlign.Center);
        animationLabel.setArrangementMode(XLabel.XArrangementMode.SingleRowNotMove);
        animationLabel.setCenterPosition(0, -0.15f, CalculateUtils.CENTER_Z);
        animationLabel.setTextColor(Color.WHITE);
        animationLabel.setSize(0.38f, 0.02f);
        addActor(animationLabel);
...
//        mGIFActor = new XAnimGIFImage("/sdcard/gif/40000306.gif", XUI.Location.SDCARD);
        ...
        mGIFActor.setCenterPosition(-0.2f, -0.25f, CalculateUtils.CENTER_Z);
        mGIFActor.setSize(0.15f, 0.15f);
...
//        mSAMActor = new XAnimSAMImage("/sdcard/sam/bmwi8.sam", "audio1", "/sdcard/sam/audio1.mp3", XUI.Location.SDCARD);
        ...
        mSAMActor.setCenterPosition(-0.1f, -0.25f, CalculateUtils.CENTER_Z);
        mSAMActor.setSize(0.15f, 0.15f);
        ...
        mSpritActor.setCenterPosition(0.15f, -0.25f, CalculateUtils.CENTER_Z);
        mSpritActor.setSize(0.15f, 0.15f);
