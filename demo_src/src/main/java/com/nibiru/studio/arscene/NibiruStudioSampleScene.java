...
public class NibiruStudioSampleScene extends XBaseScene implements IXActorEventListener {
    ...
    public void onCreate() {
        ...
        mEnterLabel.setCenterPosition(0, 0.0f, CalculateUtils.CENTER_Z);
        mEnterLabel.setSize(0.18f, 0.02f);
        ...
        mExitLabel.setCenterPosition(0, -0.1f, CalculateUtils.CENTER_Z);
        mExitLabel.setSize(0.04f, 0.02f);
...
//        setGazeFollowPanelSpace(0, 0, CalculateUtils.CENTER_Z_BG - 0.01f, 1f, 1f);
