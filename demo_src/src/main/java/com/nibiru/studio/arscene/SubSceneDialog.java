...
public class SubSceneDialog extends BaseScene {
    ...
    void dialog() {
        ...
        panoImageText.setSize(0.15f, 0.15f);
        panoImageText.setSizeOfImage(0.15f, 0.15f);
        ...
        itenable.setLayoutParam(new XActorGroup.LayoutParam(0, -0.1f, 0.02f, 1));
        itenable.setSizeOfImage(0.04f, 0.04f);
        itenable.setSize(0.04f, 0.04f);
        ...
        xdialog.setCenterPosition(0f, 0f, CalculateUtils.CENTER_Z);
        xdialog.setSize(0.15f, 0.15f);
...
//        xdialog.setEnableShowOnGazePosition(true);
    ...
    public boolean onKeyDown(int key){
        if( key == NibiruKeyEvent.KEYCODE_ENTER ){
            ...
            //在按Back键时当前显示的Dialog将被销毁，此时应重新创建
