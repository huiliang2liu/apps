 ...
 */
public class SubSceneGoto extends BaseScene implements IXActorEventListener {
    ...
    public void init() {
        ...
        mStartSettingLabel.setCenterPosition(0, 0.05f, CalculateUtils.CENTER_Z);
        mStartSettingLabel.setSize(0.38f, 0.025f);
        ...
        mStartForActivityResultLabel.setCenterPosition(0, 0.0f, CalculateUtils.CENTER_Z);
        mStartForActivityResultLabel.setSize(0.38f, 0.025f);
        ...
        mStartForSceneResultLabel.setCenterPosition(0, -0.05f, CalculateUtils.CENTER_Z);
        mStartForSceneResultLabel.setSize(0.38f, 0.025f);
        ...
        mResultLabel.setCenterPosition(0, -0.15f, CalculateUtils.CENTER_Z);
        mResultLabel.setSize(0.58f, 0.02f);
    ...
    public boolean onGazeTrigger(XActor actor) {
        ...
        //Launch Activity in other apps through package names
            ...
            Intent intent = utils.getAppIntent("com.android.nibiru.settings.vr.mr");
